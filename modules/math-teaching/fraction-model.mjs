...
export function fractionLesson(a,d,b,e,op){
  if(![a,d,b,e].every(Number.isInteger)||d<1||d>10||e<1||e>10||a<0||a>d||b<0||b>e||!['add','sub'].includes(op))throw Error('分母請填 1～10；分子請填 0～分母的整數。');
...
export function fractionSteps(s){return [

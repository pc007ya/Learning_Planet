import { h as I, B as j, j as C, q as F, r as Y, d as f, I as V, O as Z, s as X, t as A, u as T, k as S, n as k, v as R, V as g, w as H, x as _, y as U, F as Q, z as D, m as N, A as J, J as K, p as B, a as G, G as y, l as M, K as tt, N as et, U as st, X as L, Y as at, Z as it, D as ot, W as nt, _ as rt, $ as ct, a0 as lt, P as ht } from "./RoundedBoxGeometry-CV-2QMmK.mjs";
import { L as $, F as P, i as dt, b as z, c as ut } from "./car-art-D34K7c64.mjs";
...
class mt extends I {
  constructor() {
    ...
    const e = new C({ side: F }), s = new C(), n = new Y(16777215, 900, 28, 2);
...
function ft(m) {
  const t = () => new _({ color: 1478316, metalness: 0.48, roughness: 0.24, clearcoat: 1, clearcoatRoughness: 0.13 }), e = (r, h = 0.2) => new C({ color: r, metalness: h, roughness: 0.3 }), s = (r, h, d = 0, u = 0, c = 0) => {
    const l = new f(r, h);
    return l.position.set(d, u, c), m.add(l), l;
  }, n = (r, h, d, u, c, l, p = 0) => s(new N(r, h, d, 3, Math.min(r, h, d) * 0.28), e(u), c, l, p), a = new A();
  ...
  const o = (r, h = 1255995) => {
    const d = new U();
    d.setAttribute("position", new Q(r.flat(), 3)), d.setIndex([0, 1, 2, 0, 2, 3]), d.computeVertexNormals();
    const u = e(h, 0.35);
    return u.side = D, u.roughness = 0.16, s(d, u);
  };
  for (const r of [-1, 1]) {
    const h = 0.667 * r;
    o([[-1.29, 0.65, h], [-0.98, 1.27, h], [-0.54, 1.27, h], [-0.54, 0.65, h]]), o([[-0.47, 0.65, h], [-0.47, 1.27, h], [0.26, 1.27, h], [0.72, 0.65, h]]), n(0.055, 0.66, 0.038, 1582382, -0.5, 0.97, h), n(3.16, 0.026, 0.04, 12179163, -0.03, 0.55, 0.801 * r), n(0.27, 0.06, 0.06, 14870505, -0.12, 0.43, 0.815 * r), n(1.08, 0.085, 0.045, 2108725, 0, -0.22, 0.815 * r), s(new S(0.13, 20, 12), e(15855333), 0.67, 0.68, 0.89 * r).scale.set(1.15, 0.8, 0.66);
    for (const c of [-1.18, 1.18]) s(new k(0.588, 0.045, 8, 36, Math.PI), e(2437690), c, -0.3, 0.805 * r);
    const u = new R([new g(-0.49, 0.51, 0.802 * r), new g(-0.49, -0.1, 0.802 * r), new g(0.48, -0.1, 0.802 * r), new g(0.64, 0.5, 0.802 * r)]);
  ...
  for (const r of [-0.5, 0.5]) {
    const h = s(new S(0.18, 24, 16), e(16774350, 0.45), 1.985, 0.25, r);
    h.scale.x = 0.27;
    const d = s(new k(0.185, 0.024, 8, 32), e(14410211, 0.8), 2, 0.25, r);
    d.rotation.y = Math.PI / 2, s(new S(0.14, 20, 12), e(12329790), -1.98, 0.24, r).scale.set(0.25, 1.3, 0.7);
  }
...
class yt {
  constructor(t, e, s, n, a, i, o, r) {
    if (this.kind = t, this.scene = e, this.camera = s, this.stage = n, this.host = a, this.wake = o, this.action = r, this.yaw = t === "clock" ? -0.25 : -0.55, a.classList.add("il-mechanism"), n.classList.add("mech-stage"), n.setAttribute("role", "group"), i) {
      const c = new J(i), l = new mt();
      this.env = c.fromScene(l, 0.04), e.environment = this.env.texture, l.dispose(), c.dispose(), i.toneMapping = K, i.toneMappingExposure = 1.05;
    }
    ...
    h.className = "mech-toolbar", h.innerHTML = `<div class="mech-modes" role="group" aria-label="模型觀看方式"><button data-view="whole" aria-pressed="true">完整外觀</button><button data-view="xray" aria-pressed="false">透視裡面</button><button data-view="explode" aria-pressed="false">拆開看看</button></div><div class="mech-adjust"><label>轉個方向<input type="range" data-mech-turn min="-75" max="75" value="${Math.round(this.yaw * 180 / Math.PI)}" aria-label="轉動模型視角"></label><label>拆開多少<input type="range" data-mech-explode min="0" max="100" value="0" aria-label="零件拆開程度"></label></div>`, n.before(h), t === "clock" && (h.innerHTML = '<div class="clock-switches"><button role="switch" data-clock-rotate aria-checked="false" aria-label="旋轉模型" title="旋轉模型">⟳</button><button role="switch" data-clock-explode aria-checked="false" aria-label="拆卸零件" title="拆卸零件">⚙</button><span hidden>☝ 拖動調時</span></div>', a.querySelector(".bp-heading").append(h.firstElementChild), h.remove()), t === "car" && (a.classList.add("il-car-play"), a.dataset.carMode = "rotate", h.innerHTML = '<div class="car-switches" role="group" aria-label="回力車操作模式"><button role="switch" data-car-mode="rotate" aria-checked="true">⟳ 旋轉<i></i></button><button role="switch" data-car-mode="explode" aria-checked="false">⚙ 拆卸<i></i></button><button role="switch" data-car-mode="test" aria-checked="false">🏁 拉力<i></i></button></div>');
    const d = document.createElement("section");
    if (d.className = "mech-tray", d.innerHTML = `<div class="mech-tray-title"><strong>點零件，發現小祕密</strong><span data-discovered>0 / 8</span></div><div class="mech-parts">${E[t].map((c, l) => `<button data-part="${c[0]}" aria-pressed="false"><span>${l + 1}</span>${c[1]}</button>`).join("")}</div><div class="mech-part-info" aria-live="polite"><strong>從外面看，再拆開找找看。</strong><p>點模型上的數字，或點上方的零件名稱。</p></div><details class="mech-parent"><summary>給陪玩的家長</summary><p>先問「你猜這個零件做什麼？」再點名稱一起看。${t === "clock" ? "電池 → 石英與電路 → 馬達 → 齒輪 → 指針。" : "手往後拉 → 輪軸與齒輪 → 捲簧儲能 → 放手帶動車輪。"}此模型以常見結構為基礎，省略部分緊固件與細小傳動零件，並非品牌產品的維修拆裝圖。真實拆解請由成人協助，避免小零件與電池被孩子吞食。</p></details>`, n.closest(".il-scene-panel").append(d), this.partInfo = d.querySelector(".mech-part-info"), t === "clock") {
      const c = document.createElement("details");
      c.className = "mech-bom", c.innerHTML = '<summary aria-label="展開或收起零件表" title="零件">☷</summary>', c.append(d), n.append(c), c.addEventListener("toggle", () => this.wake(), { signal: this.abort.signal }), d.querySelector("strong").textContent = "零件";
      const l = document.createElement("div");
      l.className = "clock-zoom", l.innerHTML = '<button data-clock-zoom="1" aria-label="放大模型">＋</button><button data-clock-zoom="-1" aria-label="縮小模型">−</button><button data-clock-zoom="0" aria-label="還原視角">⌂</button>', n.append(l), this.halo = document.createElement("div"), this.halo.className = "mech-selection-halo", this.halo.hidden = !0, n.append(this.halo);
    }
    const u = document.createElement("div");
    u.className = "mech-quick-info", u.setAttribute("aria-live", "polite"), u.innerHTML = "<strong>當個小小拆解師</strong><p>選「拆開看看」，再點一個零件。</p>", a.querySelector("aside .il-controls").before(u), t === "car" && (u.innerHTML = "<strong>選個開關玩玩看</strong><p>轉一轉、拆一拆，再試跑！</p>"), t === "clock" && (u.innerHTML = "<strong>☝ 拖動調時</strong><p>⚙ 拆卸 · ☷ 找零件</p>"), a.addEventListener("click", (c) => {
      const l = c.target.closest("button");
      if (l) {
        if (l.dataset.carMode && this.setCarMode(l.dataset.carMode === this.carMode ? "idle" : l.dataset.carMode), l.dataset.view && (this.setMode(l.dataset.view), h.querySelectorAll("[data-view]").forEach((p) => p.setAttribute("aria-pressed", String(p === l))), h.querySelector("[data-mech-explode]").value = this.mode === "explode" ? "100" : "0"), l.dataset.part && this.select(l.dataset.part, a), l.hasAttribute("data-clock-rotate") && (this.clockRotate = !this.clockRotate, l.setAttribute("aria-checked", String(this.clockRotate))), l.hasAttribute("data-clock-explode")) {
          const p = this.mode !== "explode";
          this.setMode(p ? "explode" : "whole"), l.setAttribute("aria-checked", String(p));
        }
        if ((l.hasAttribute("data-clock-rotate") || l.hasAttribute("data-clock-explode")) && (a.querySelector(".clock-switches > span").textContent = this.clockRotate || this.mode === "explode" ? "☝ 拖動旋轉" : "☝ 拖動調時", u.innerHTML = this.mode === "explode" ? "<strong>☷ 找零件</strong><p>點數字，聽聽它的工作。</p>" : this.clockRotate ? "<strong>☝ 拖動旋轉</strong><p>關閉旋轉，就能調時間。</p>" : "<strong>☝ 拖動調時</strong><p>長分針一圈，短時針一格。</p>"), l.hasAttribute("data-clock-zoom")) {
          const p = Number(l.dataset.clockZoom);
          this.zoom = p ? Math.max(0.75, Math.min(1.5, this.zoom + p * 0.15)) : 1, p || (this.yaw = -0.25), this.wake();
        }
      }
    }, { signal: this.abort.signal }), h.addEventListener("input", (c) => {
      const l = c.target;
      l.hasAttribute("data-mech-turn") ? this.yaw = Number(l.value) * Math.PI / 180 : (this.target = Number(l.value) / 100, this.mode = this.target ? "explode" : "whole", h.querySelectorAll("[data-view]").forEach((p) => p.setAttribute("aria-pressed", String(p.dataset.view === this.mode))), this.skins()), this.wake();
    }, { signal: this.abort.signal }), t === "clock" ? this.clock() : this.car(), e.add(this.root), this.skins(), n.addEventListener("pointerdown", (c) => {
      c.button || c.target.closest("button,details") || t === "car" && this.carMode === "idle" || (this.dragYaw = this.yaw, this.dragPull = this.pullValue, this.dragging = { x: c.clientX, minutes: this.minutes, moved: !1 }, n.setPointerCapture(c.pointerId));
    }, { signal: this.abort.signal }), n.addEventListener("pointermove", (c) => {
      if (!this.dragging) return;
      const l = c.clientX - this.dragging.x;
    ...
    }, { signal: this.abort.signal }), n.addEventListener("pointerup", (c) => {
      if (!this.dragging) return;
      const l = this.dragging.moved;
      if (this.dragging = null, n.hasPointerCapture(c.pointerId) && n.releasePointerCapture(c.pointerId), l && this.mode === "whole" && (t === "clock" && !this.clockRotate || this.carMode === "test")) this.action(-1, !0);
      else if (!l) {
        const p = n.getBoundingClientRect(), b = new B();
        b.setFromCamera(new G((c.clientX - p.left) / p.width * 2 - 1, 1 - (c.clientY - p.top) / p.height * 2), s);
        const v = b.intersectObject(this.root, !0);
        for (const W of v) {
          let x = W.object;
  ...
  material(t, e = 0.1, s = 0.32) {
    return new C({ color: t, metalness: e, roughness: s });
  }
  mesh(t, e, s, n = 0, a = 0, i = 0, o = 0.1) {
    const r = new f(t, this.material(e, o));
    return r.position.set(n, a, i), s.add(r), r;
  }
  box(t, e, s, n, a, i = 0, o = 0, r = 0) {
    return this.mesh(new N(t, e, s, 3, Math.min(t, e, s) * 0.16), n, a, i, o, r);
  }
  disk(t, e, s, n, a = 0, i = 0, o = 0) {
    const r = this.mesh(new M(t, t, e, 64), s, n, a, i, o, 0.4);
  ...
  part(t, e, s, n = !1) {
    ...
    i.type = "button", i.dataset.part = t, i.textContent = String(E[this.kind].findIndex((r) => r[0] === t) + 1), i.setAttribute("aria-label", E[this.kind].find((r) => r[0] === t)[1]), this.labelLayer.append(i);
    const o = document.createElementNS("http://www.w3.org/2000/svg", "line");
    return this.labelLayer.querySelector("svg").append(o), this.parts.push({ id: t, group: a, home: new g(...e), away: new g(...this.kind === "clock" ? gt[t] : s), skin: n, button: i, line: o }), a;
  }
  gear(t, e, s, n, a, i, o = 14265434) {
    ...
    const h = new A();
    for (let c = 0; c < e * 4; c++) {
      const l = c * Math.PI * 2 / (e * 4), p = t * (c % 4 === 0 || c % 4 === 3 ? 0.9 : 1.05), b = Math.cos(l) * p, v = Math.sin(l) * p;
      c ? h.lineTo(b, v) : h.moveTo(b, v);
    }
    h.closePath();
    const d = this.kind === "clock" && e === 36, u = new tt();
    if (u.absarc(0, 0, t * (d ? 0.68 : 0.16), 0, Math.PI * 2, !0), h.holes.push(u), this.mesh(new T(h, { depth: 0.12, bevelEnabled: !0, bevelSize: 0.012, bevelThickness: 0.012, bevelSegments: 2 }), o, r, 0, 0, 0, 0.65), d) for (let c = 0; c < 3; c++) {
      const l = c * Math.PI * 2 / 3, p = this.box(0.035, t * 0.62, 0.08, o, r, Math.sin(l) * t * 0.43, Math.cos(l) * t * 0.43, 0.06);
      p.rotation.z = -l;
    }
  ...
  clock() {
    ...
    this.disk(1.8, 0.5, 2847620, t), this.mesh(new k(1.7, 0.15, 16, 96), 12758396, t, 0, 0, 0.32, 0.8), this.box(0.3, 0.65, 0.5, 2847620, t, -0.95, -1.7), this.box(0.3, 0.65, 0.5, 2847620, t, 0.95, -1.7);
    const e = this.part("glass", [0, 0, 0.7], [3.3, 0.3, 1.4], !0), s = this.disk(1.62, 0.045, 14087679, e);
    s.material.transparent = !0, s.material.opacity = 0.1, s.material.depthWrite = !1, this.mesh(new k(1.64, 0.035, 12, 96), 10470606, e, 0, 0, 0, 0.7);
    ...
    const o = new et(a);
    o.colorSpace = st, this.textures.push(o), this.mesh(new L(1.6, 96), 16314847, n, 0, 0, -6e-3);
    const r = this.mesh(new L(1.6, 96), 16777215, n);
    r.name = "clock-marks", r.material.map = o, r.material.roughness = 0.7, r.material.side = D;
    ...
    const d = this.part("gears", [0, 0, 0.08], [0.05, 0.5, 0.1]);
    this.gear(0.2, 12, d, 0, 0, 0.19, 2212059), this.gear(0.6, 36, d, 0.8, 0, 0.19, 15254129), this.gear(0.16, 10, d, 0.8, 0, -0.04, 15254129), this.compoundTag = document.createElement("span"), this.compoundTag.className = "clock-compound-tag", this.compoundTag.textContent = "10T · 同軸", this.stage.append(this.compoundTag), this.gear(0.64, 40, d, 0, 0, -0.04, 15116615), this.disk(0.055, 0.45, 13490664, d, 0.8, 0, 0.1);
    const u = this.part("motor", [-0.55, -0.7, 0.04], [-1.5, -1.25, 0.35]);
    this.box(0.65, 0.3, 0.3, 12019250, u);
    for (let p = 0; p < 16; p++) this.mesh(new k(0.16, 0.013, 6, 20), 15049082, u, -0.28 + p * 0.036, 0, 0.08, 0.8).rotation.y = Math.PI / 2;
    this.disk(0.19, 0.15, 9870758, u, 0.4, 0, 0.05);
    const c = this.part("quartz", [0.45, -0.75, 0.05], [0.35, -1.5, 0.2]);
    this.box(0.72, 0.46, 0.06, 2980194, c), this.box(0.22, 0.18, 0.07, 2237738, c, -0.08, 0, 0.06), this.box(0.14, 0.3, 0.1, 12895943, c, 0.23, 0, 0.07), this.rotor.position.set(0.4, 0, 0.18), u.add(this.rotor), this.box(0.28, 0.045, 0.06, 16575637, this.rotor), this.box(0.045, 0.28, 0.06, 16575637, this.rotor);
    const l = this.part("battery", [0, -1.25, -0.48], [-2.6, -1.6, -0.1]);
    this.mesh(new M(0.19, 0.19, 1.25, 32), 13351808, l, 0, 0, 0, 0.6).rotation.z = Math.PI / 2, this.mesh(new M(0.2, 0.2, 0.27, 32), 2371136, l, 0.47, 0, 0).rotation.z = Math.PI / 2, this.mesh(new M(0.09, 0.09, 0.05, 16), 14278628, l, -0.65, 0, 0, 0.8).rotation.z = Math.PI / 2;
  }
  car() {
    ...
    for (const d of [-1.3, 1.3]) for (const u of [-0.52, 0.52])
      this.disk(0.075, 0.09, 14146270, e, d, 0.05, u).rotation.x = 0;
    const s = this.part("wheels", [0, 0, 0], [0, -0.35, 0]);
    for (const d of [-1.18, 1.18]) for (const u of [-0.88, 0.88]) {
      const c = new y();
      c.position.set(d, 0.06, u), c.userData.side = u < 0 ? -1 : 1, s.add(c), this.mesh(new k(0.36, 0.145, 16, 48), 2106923, c).scale.z = 1.2, this.disk(0.28, 0.19, 12174797, c), this.disk(0.235, 0.2, 2438206, c), this.disk(0.09, 0.25, 13359326, c);
      const l = u > 0 ? 0.13 : -0.13;
      this.mesh(new k(0.27, 0.022, 8, 40), 14870763, c, 0, 0, l, 0.8);
      for (let p = 0; p < 5; p++) {
        const b = p * Math.PI * 2 / 5, v = this.box(0.048, 0.17, 0.035, 14542313, c, Math.sin(b) * 0.165, Math.cos(b) * 0.165, l);
        v.rotation.z = -b;
      }
      this.wheels.push(c);
    }
    const n = this.part("axles", [0, 0.07, 0], [0, -0.58, 0]);
    for (const d of [-1.18, 1.18]) this.disk(0.07, 1.83, 13488855, n, d, 0, 0);
    const a = this.part("housing", [-0.65, 0.5, 0], [-0.95, 0.7, -1.7], !0);
    this.box(1.25, 0.65, 0.8, 14801605, a);
    const i = this.part("spring", [-0.58, 0.52, 0.1], [-1.8, 0.6, 1.1]), o = Array.from({ length: 300 }, (d, u) => {
      const c = u * 0.18, l = 0.035 + u * 1e-3;
      return new g(Math.cos(c) * l, Math.sin(c) * l, 0);
    });
  ...
  select(t, e) {
    ...
    const s = E[this.kind].find((n) => n[0] === t);
  ...
  frame(t) {
    ...
    if (e && s) {
      const a = this.kind === "clock" && this.stage.querySelector(".mech-bom[open]") ? 260 : 0, i = this.kind === "clock" ? this.stage.querySelector(".clock-transmission[open]") : null, o = i ? i.offsetWidth + 20 : 0, r = this.kind === "clock" ? 2.6 + this.amount * 3.3 : this.carMode === "test" ? 5.8 : 3.3 + this.amount * 1.4, h = Math.max(this.kind === "clock" ? 2.45 + this.amount * 0.9 : 2.35 + this.amount * 0.95, r * s / Math.max(280, e - a - o)) / (this.zoom || 1), d = h * e / s, u = this.kind === "car" ? this.carMode === "test" ? -0.445 + 0.28 * h : 0.45 : 0, c = d * (a - o) / e;
      this.camera.left = -d + c, this.camera.right = d + c, this.camera.top = h + u, this.camera.bottom = -h + u, this.camera.updateProjectionMatrix();
    }
    ...
    }), this.root.updateMatrixWorld(!0), this.compoundTag) {
    ...
    if (this.halo) {
      ...
      if (this.halo.hidden = !a || this.mode === "whole" && !["case", "glass", "dial", "hands"].includes(this.selected), a) {
        ...
        for (const d of [i.min.x, i.max.x]) for (const u of [i.min.y, i.max.y]) for (const c of [i.min.z, i.max.z]) {
          const l = new g(d, u, c).project(this.camera);
          o.push({ x: (l.x + 1) * e / 2, y: (1 - l.y) * s / 2 });
        }
        const r = Math.min(...o.map((d) => d.x)) - 8, h = Math.min(...o.map((d) => d.y)) - 8;
        Object.assign(this.halo.style, { left: `${r}px`, top: `${h}px`, width: `${Math.max(...o.map((d) => d.x)) - r + 8}px`, height: `${Math.max(...o.map((d) => d.y)) - h + 8}px` });
      }
    }
    const n = [];
    return this.parts.forEach((a) => {
      const i = a.group.getWorldPosition(new g()).project(this.camera), o = { x: (i.x + 1) * e / 2, y: (1 - i.y) * s / 2 }, h = [[0, 0], [40, 0], [-40, 0], [0, 40], [0, -40], [40, 40], [-40, -40], [60, -40], [-60, 40], [0, 80]].map(([d, u]) => ({ x: Math.max(20, Math.min(e - 20, o.x + d)), y: Math.max(20, Math.min(s - 20, o.y + u)) })).find((d) => n.every((u) => Math.hypot(u.x - d.x, u.y - d.y) > 37)) || o;
      a.button.hidden = this.mode !== "explode" && a.id !== this.selected, a.button.hidden || n.push(h), a.button.style.left = `${h.x}px`, a.button.style.top = `${h.y}px`, a.button.classList.toggle("selected", a.id === this.selected), a.line.setAttribute("x1", String(o.x)), a.line.setAttribute("y1", String(o.y)), a.line.setAttribute("x2", String(h.x)), a.line.setAttribute("y2", String(h.y)), a.line.style.display = a.button.hidden ? "none" : "";
...
function vt(m) {
  return Object.values(kt(m)).map((t) => t >= 0.999999 ? "1" : `1/${Math.round(1 / t)}`);
}
...
class Ct {
  constructor(t, e) {
    ...
    if (e === "clock") {
      ...
      const r = (h) => `<svg viewBox="0 0 160 160" role="img" aria-label="${h}點"><circle cx="80" cy="80" r="70" fill="#fff5db" stroke="#cba85c" stroke-width="7"/>${Array.from({ length: 12 }, (d, u) => `<circle cx="${80 + 59 * Math.sin(u * Math.PI / 6)}" cy="${80 - 59 * Math.cos(u * Math.PI / 6)}" r="3" fill="#294651"/>`).join("")}<path d="M80 80V25" stroke="#168ba8" stroke-width="6" stroke-linecap="round"/><path d="M80 80L${80 + 36 * Math.sin(h * Math.PI / 6)} ${80 - 36 * Math.cos(h * Math.PI / 6)}" stroke="#a47818" stroke-width="9" stroke-linecap="round"/><circle cx="80" cy="80" r="6" fill="#294651"/></svg>`;
      t.querySelector(".il-assessment > p").innerHTML = `<span class="clock-question">${r(12)}<span aria-label="分針前進一圈">⟳ → ?</span></span>`, t.querySelector(".il-assessment h3").textContent = "分針一圈，時針？", t.querySelector(".il-answers").innerHTML = [12, 12, 1].map((h, d) => `<button data-answer="${d}" aria-label="${s.choices[d]}">${r(h).replace("</svg>", d === 0 ? '<path d="M92 38A44 44 0 1 1 69 37M65 29 70 39 59 43" fill="none" stroke="#b07e16" stroke-width="5" stroke-linecap="round"/></svg>' : d === 2 ? '<path d="M80 37A43 43 0 0 1 102 43" fill="none" stroke="#b07e16" stroke-width="6"/></svg>' : "</svg>")}<span>${d === 0 ? "⟳ 一圈" : d === 1 ? "不動" : "一大格"}</span></button>`).join("");
    }
  ...
  renderer;
  scene = new I();
  camera = new rt(-5, 5, 3.6, -3.6, 0.1, 100);
  object = new y();
  mechanism;
  experience;
  abort = new AbortController();
  ...
  mesh(t, e, s = 0, n = 0, a = 0, i = this.scene) {
    const o = new f(t, new C({ color: e, roughness: 0.55, metalness: 0.12 }));
    return o.position.set(s, n, a), i.add(o), o;
  }
  box(t, e, s, n, a, i, o = 0, r) {
    return this.mesh(new j(t, e, s), n, a, i, o, r);
  }
  buildTank() {
  ...
  disposeObject(t) {
    t.traverse((e) => {
      e instanceof f && (e.geometry.dispose(), (Array.isArray(e.material) ? e.material : [e.material]).forEach((n) => n.dispose()));
    });
  }
  buildSample() {
    this.disposeObject(this.object), this.object.clear();
    const t = P[this.selected];
    if (t.id === "stone" && this.mesh(new ct(0.48), t.color, 0, 0, 0, this.object).scale.set(1.25, 0.8, 0.8), t.id === "key" && (this.mesh(new k(0.25, 0.09, 10, 32), t.color, -0.35, 0.05, 0, this.object), this.box(0.85, 0.12, 0.13, t.color, 0.25, 0.05, 0, this.object), this.box(0.12, 0.25, 0.13, t.color, 0.5, -0.08, 0, this.object), this.box(0.12, 0.2, 0.13, t.color, 0.25, -0.05, 0, this.object)), t.id === "boat") {
      const e = new A();
  ...
  click = (t) => {
    ...
    if (e) {
      if (e.hasAttribute("data-rpm-size")) {
        const n = this.stage.querySelector(".clock-transmission").classList.toggle("is-large");
        e.setAttribute("aria-pressed", String(n)), e.setAttribute("aria-label", n ? "縮小轉速面板" : "放大轉速面板"), this.wake();
        return;
      }
      if (e.dataset.rpmSpeed) {
        ...
        const n = vt(s ? 60 : 1);
        this.host.querySelectorAll("[data-rpm]").forEach((a, i) => a.textContent = n[i] + " RPM"), this.host.querySelector("[data-rpm-motor]").textContent = `動畫 ${s ? 60 : 1} RPM（非實機）`;
        return;
      }
      ...
      if (this.kind === "clock" && (["quiz", "notes", "help"].includes(e.dataset.helper || "") || e.hasAttribute("data-clock-rotate") || e.hasAttribute("data-clock-explode") || e.dataset.action === "step") && (this.active = !1, this.updateClock()), this.kind === "clock" && (e.hasAttribute("data-clock-rotate") || e.hasAttribute("data-clock-explode") || e.dataset.action === "step") && (this.demoStarted = !1, this.mechanism?.setClockDemo(!1)), this.kind === "car" && ((e.dataset.carMode || e.dataset.part) && (this.active = !1), e.dataset.road && (this.active = !1, this.rough = e.dataset.road === "rough", this.host.dataset.road = e.dataset.road, this.host.querySelectorAll("[data-road]").forEach((s) => s.setAttribute("aria-pressed", String(s === e))), this.updateCar(), this.status.textContent = this.rough ? "換成石頭路，試試看能跑多遠。" : "換成平路，用相同力量比較看看。"), e.dataset.force && (this.active = !1, this.pull = Number(e.dataset.force), this.mechanism?.setCarMode("test"), this.updateCar())), e.dataset.answer !== void 0) {
        if (this.kind === "car") {
          const s = Number(e.dataset.answer) === $.car.answer, n = this.answerReady ? s ? "答對了！往後拉車時，能量存在捲簧裡。放手後，捲簧透過齒輪帶動車輪。" : "再想想看！回到實驗，拆開車殼看看捲簧，聽聽它的工作。" : "先回到實驗，完成一次拉車試跑，再來選圖片。";
  ...
  run() {
    if (this.kind === "buoyancy") {
      ...
      const t = P[this.selected], e = z(t.mass, t.volume);
  ...
  point(t) {
    ...
    const n = new g();
    return s.ray.intersectPlane(new ht(new g(0, 0, 1), 0), n), n;
  }
  pointerDown = (t) => {
  ...
  tick = (t) => {
    ...
    if (this.last = t, this.active && this.kind === "buoyancy" && (this.object.position.y += (this.targetY - this.object.position.y) * Math.min(1, s * 3), Math.abs(this.object.position.y - this.targetY) < 0.015)) {
      this.active = !1;
      const a = P[this.selected], i = z(a.mass, a.volume);

import { L as o, F as r, a as h, b as p } from "./experience-Dm_KmH3D.mjs";
...
class g {
  ...
  drop(t = 0.5) {
    ...
    const e = r[this.selected], s = p(e.mass, e.volume), i = this.prediction;

...
function a() {
  ...
  document.querySelectorAll("[data-interactive-lab]").forEach((e) => {
    ...
    r.add(e), (t === "cube" ? import("./cube-lab-C1hQQSPz.mjs").then(({ CubeLab: n }) => () => new n(e)) : t === "buoyancy" ? import("./buoyancy-play-PwKAi1LT.mjs").then(({ BuoyancyPlay: n }) => () => new n(e)) : import("./lab-lxRf2h2j.mjs").then(({ InteractiveLab: n }) => () => new n(e, t))).then((n) => {

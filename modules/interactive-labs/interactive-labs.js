...
function r() {
  ...
  document.querySelectorAll("[data-interactive-lab]").forEach((e) => {
    ...
    d.add(e), (t === "mini4wd" ? import("./mini4wd-lab-CwI8caZ0.mjs").then(({ Mini4wdLab: n }) => () => new n(e)) : t === "cube" ? import("./cube-lab-CokQKIEx.mjs").then(({ CubeLab: n }) => () => new n(e)) : t === "buoyancy" ? import("./buoyancy-play-DchAEolo.mjs").then(({ BuoyancyPlay: n }) => () => new n(e)) : import("./lab-CREQjUin.mjs").then(({ InteractiveLab: n }) => () => new n(e, t))).then((n) => {

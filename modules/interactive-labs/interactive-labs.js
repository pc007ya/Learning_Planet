...
function a() {
  ...
  document.querySelectorAll("[data-interactive-lab]").forEach((e) => {
    ...
    r.add(e), (t === "cube" ? import("./cube-lab-y8-zEga7.mjs").then(({ CubeLab: n }) => () => new n(e)) : t === "buoyancy" ? import("./buoyancy-play-BSy_qbL3.mjs").then(({ BuoyancyPlay: n }) => () => new n(e)) : import("./lab-DZ4Bnrtr.mjs").then(({ InteractiveLab: n }) => () => new n(e, t))).then((n) => {
